...
urlpatterns = [
	...
	path('view_questionset/',views.viewqstnpage,name='view question set'),
	
	path('view_questionset/view_questions/',views.viewqstnpage1,name='view questions'),
	
	
	
	path('view_questionset/view_questions/viewfn/',views.viewfn,name='view questions fn'),
	path('view_questionset/view_questions/check/',views.checkradio,name='check questions fn'),
	
	path('view_questionset/view_questions/result/',views.resultpage,name='view questions fn'),
	path('view_questionset/view_questions/resultfinal/',views.checkresult,name='view questions fn'),
	path('view_questionset/view_questions/result/viewfn/',views.viewtotalfn,name='view questions fn'),
